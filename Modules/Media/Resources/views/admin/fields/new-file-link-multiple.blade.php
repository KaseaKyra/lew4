<div class="form-group">
    ...
    <a class="btn btn-primary btn-upload" onclick="openMediaWindowMultiple(event, '{{ $zone }}')"><i
    ...
    <div class="jsThumbnailImageWrapper">
        ...
        <figure data-id="{{ $file->id }}">
            ...
            <img src="{{ Imagy::getThumbnail($file->path, (isset($thumbnailSize) ? $thumbnailSize : 'mediumThumb')) }}"
