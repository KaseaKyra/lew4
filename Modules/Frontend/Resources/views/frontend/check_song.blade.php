        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="mt-3 bgc-2 py-2 index-p__cl">
                    ...
                    <div id="s__content">
                        {!! Form::open(['route' => ['frontend.item.song', $song->id], 'method' => 'post']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mx-5 font-weight-bold">Your answer:</p>
                                <div class="form-group mx-5">
                                    <label for="a1" class="mr-3">Answer 1</label>
                                    <input type="text" class="text-center" id="a1" name="a1"
                                           value="{{$request->a1}}"><br>
                                    <label for="a2" class="mr-3">Answer 2</label>
                                    <input type="text" class="text-center" id="a2" name="a2"
                                           value="{{$request->a2}}"><br>
                                    <label for="a3" class="mr-3">Answer 3</label>
                                    <input type="text" class="text-center" id="a3" name="a3"
                                           value="{{$request->a3}}"><br>
                                    <label for="a4" class="mr-3">Answer 4</label>
                                    <input type="text" class="text-center" id="a4" name="a4"
                                           value="{{$request->a4}}"><br>
                                    <label for="a5" class="mr-3">Answer 5</label>
                                    <input type="text" class="text-center" id="a5" name="a5" value="{{$request->a5}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <p class="mx-5 font-weight-bold">Key words</p>
                                <div class="form-group mx-5">
                                    <label for="a1" class="mr-3">Answer 1</label>
                                    <input type="text" class="text-center" id="a1" name="a1"
                                           value="{{$answer->a1}}"><br>
                                    ...
                                    <input type="text" class="text-center" id="a4" name="a4"
                                           value="{{$answer->a4}}"><br>
                                    <label for="a5" class="mr-3">Answer 5</label>
                                    <input type="text" class="text-center" id="a5" name="a5" value="{{$answer->a5}}">
                                </div>
                            </div>
                        </div>
...
{{--                            <button type="submit" class="btn btn-primary float-right ml-3" name="check" id="check">
                            ...
                            <a href="{{route(['frontend.item.song', $song->id])}}" type="button" class="btn btn-primary
                            float-right">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="mt-3 bgc-2 py-2 index-p__cl">
                    <a{{-- id="s__btn"--}}><i class="fas fa-caret-right mx-2"></i>Playing Game</a>
                    <div{{-- id="s__content"--}}>
                        {!! Form::open(['route' => ['frontend.check.song', $song->id], 'method' => 'get']) !!}
                        <input type="hidden" name="id" value="{{$song->id}}">
                        <div class="m-5">
                            {{strip_tags($song->lyric)}}
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h6 class="font-weight-bold mx-5 ">The answer</h6>
                                <div class="form-group mx-5">
                                    <label for="a1" class="mr-3">Answer 1</label>
                                    <input type="text" class="text-center" id="a1" name="a1"
                                           value="{{$request->a1}}"><br>
                            ...
                            <div class="col-md-6">
                                <h6 class="font-weight-bold mx-5">The keys</h6>
                                <div class="form-group mx-5">
                                    <label for="a1" class="mr-3">Answer 1</label>
                                    <input type="text" class="text-center" id="a1" name="a1"
                                           value="{{$answer->a1}}"><br>
