...
<div class="box-body">
    <div class="form-group">
        {{--        <label for="song_id" class="text-capitalize">Listening Lesson</label>
    ...
    {!! Form::normalTextarea('option 1', 'Option 1', $errors) !!}
    {!! Form::normalTextarea('option 2', 'Option 2', $errors) !!}
    {!! Form::normalTextarea('option 3', 'Option 3', $errors) !!}
</div>
